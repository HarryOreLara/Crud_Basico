      ...
      child: Column(
        children: [
          ...
          CustomTextFormField(
            ...
            onChanged: ref.read(registerFormProvier.notifier).onFullNameChange,
          ...
          CustomTextFormField(
            ...
            keyboardType: TextInputType.emailAddress,
            onChanged: (value) =>
                ref.read(registerFormProvier.notifier).onEmailChange(value),
            errorMessage: !registerForm.isFormPosted
          ...
          CustomTextFormField(
            label: 'Contraseña',
            obscureText: true,
            onChanged: ref.read(registerFormProvier.notifier).onPasswordChange,
            errorMessage: !registerForm.isFormPosted
          ...
          CustomTextFormField(
            ...
            obscureText: true,
            onChanged:
                ref.read(registerFormProvier.notifier).onPasswordTwoChange,
            errorMessage: !registerForm.isFormPosted
